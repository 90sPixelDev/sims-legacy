	...
	(this._event_id = FamilyTree._guid()),
		FamilyTree._validateConfig(this.config) &&
			...
			FamilyTree._intersectionObserver(this.element, function (e) {
				(i.isVisible = e),
					!1 !==
						FamilyTree.events.publish('visibility-change', [
							i,
						]) &&
...
(FamilyTree._defaultConfig = function (e) {
	...
	(FamilyTree.prototype._draw = function (e, t, i, r) {
		...
		if (!FamilyTree.LAZY_LOADING || this.isVisible)
			if (
				...
				var n =
					t == FamilyTree.action.init ? null : this.getViewBox();
				this.manager.read(
					e,
					this.width(),
					this.height(),
								...
								if (
									...
									if (a._initialized) {
										...
										u.removeChild(f),
											...
											a.xScrollUI.addListener(
												a.getSvg()
											),
											a.yScrollUI.addListener(
												a.getSvg()
											),
		...
		if (null != r) {
			...
			if (null != a) {
				...
				FamilyTree.events.publish('ripple', [this, b]),
					y.setAttribute(
						'x',
						b.ripple.rect ? b.ripple.rect.x : 0
					),
					y.setAttribute(
						'y',
						b.ripple.rect ? b.ripple.rect.y : 0
					),
					y.setAttribute(
						'width',
						b.ripple.rect ? b.ripple.rect.width : r.w
					),
					y.setAttribute(
						'height',
						b.ripple.rect ? b.ripple.rect.height : r.h
					),
	...
	(FamilyTree.prototype.addPartnerNode = function (e, t, i) {
		...
		if (e && Array.isArray(e.pids) && 1 == e.pids.length) {
			...
			if (!1 !== this._fireUpdate_addUpdateRemove(n, i)) {
				var l = this.getRecentRootsByNodeId(
					n.updateNodesData[0].id
				);
				FamilyTree._changeRootOption(
					this.config.roots,
					l,
				...
				if (FamilyTree.isNEU(e))
					...
					if (!1 !== this._fireUpdate_addUpdateRemove(d, a)) {
						...
						(this.config.roots = [d.addNodesData[0].id]),
							...
							FamilyTree.events.publish('updating', [
								n,
								d,
							]);
					}
	...
	(FamilyTree.LINKS_THRESHOLD = 50000),
	...
	(FamilyTree.SEARCH_PLACEHOLDER = 'Search with name or sim info...'),
	...
	(FamilyTree.LINK_ROUNDED_CORNERS = 0),
	...
	(FamilyTree._addPointTop = function (e, t, i, r, a) {
		...
		return (
			'left' == a
				? (n = e.leftNeighbor
						? e.x +
						  (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2
						: e.x - i.siblingSeparation / 2)
				: 'right' == a &&
				  (n = e.rightNeighbor
						? e.x +
						  e.w +
						  (e.rightNeighbor.x - (e.x + e.w)) / 2
			...
			this.obj.element
				...
				.addEventListener('click', function (t) {
					...
					if (!1 !== i) {
						...
						if (
							!1 ===
							FamilyTree.events.publish('save', [r, l])
						)
							return;
				...
				.addEventListener('click', function (t) {
					...
					if (i && i.hasAttribute) {
						var n = i.getAttribute('data-edit-from-btn'),
							l = {
								button: r.obj.config.editForm.buttons[
									n
								],
								name: n,
								nodeId: e,
						...
						if (
							!1 ===
							FamilyTree.events.publish('button-click', [
								r,
								l,
							])
						)
	...
	(FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
		var n,
			...
			o = JSON.parse(
				JSON.stringify(this.obj.config.editForm.elements)
			),
		...
		FamilyTree.isNEU(g) && (g = ''),
			(T = FamilyTree.isNEU(T)
				...
				: `<img style="width: 100%;height:100%;" src="${T}"></img>`);
		var w = !t,
			k = t ? 'display:none;' : '',
			S = t || !s ? 'display:none;' : '',
			...
			if (
				...
				f.menu)) {
					...
					C.setAttribute('cx', 0),
						...
						C.setAttribute(
							'r',
							a.nodeCircleMenuButton.radius
						),
						C.setAttribute('fill', _),
						C.setAttribute('stroke-width', '1'),
						C.setAttribute(
							'stroke',
							a.nodeCircleMenuButton.stroke
						),
						k.appendChild(C),
						k.appendChild(S),
						(k.innerHTML += x),
	...
	(FamilyTree.toolbarUI.expandAllIcon =
		'<svg style="margin-bottom:7px;box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid green;background-color: #fff;display: block;cursor: pointer;" width="32px" height="32px"><marker id="arrow" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="4" markerHeight="4" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="gray" /></marker><line x1="11" y1="11" x2="6" y2="6" stroke="green" stroke-width="2" marker-end="url(#arrow)" /><line x1="21" y1="11" x2="26" y2="6" stroke="green" stroke-width="2" marker-end="url(#arrow)" /><line x1="21" y1="21" x2="26" y2="26" stroke="green" stroke-width="2" marker-end="url(#arrow)" /><line x1="11" y1="21" x2="6" y2="26" stroke="green" stroke-width="2" marker-end="url(#arrow)" /><rect x="12" y="12" width="8" height="8" fill="gray"></rect></svg>'),
	(FamilyTree.toolbarUI.fitIcon =
		'<svg style="margin-bottom:7px;box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid green;background-color: #fff;display: block;cursor: pointer;" width="32px" height="32px"><path stroke-width="3" fill="none" stroke="green" d="M4,11 L4,4 L11,4"></path><path stroke-width="3" fill="none" stroke="green" d="M28,11 L28,4 L21,4"></path><path stroke-width="3" fill="none" stroke="green" d="M28,21 L28,28 L21,28"></path><path stroke-width="3" fill="none" stroke="green" d="M4,21 L4,28 L11,28"></path><circle cx="16" cy="16" r="5" fill="gray"></circle></svg>'),
	(FamilyTree.toolbarUI.openFullScreenIcon =
		'<svg  style="margin-bottom:7px;box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid green;background-color: #fff;display: block;cursor: pointer;" width="32px" height="32px"><path stroke-width="3" fill="none" stroke="green" d="M4,11 L4,4 L11,4"></path><path stroke-width="3" fill="none" stroke="green" d="M28,11 L28,4 L21,4"></path><path stroke-width="3" fill="none" stroke="green" d="M28,21 L28,28 L21,28"></path><path stroke-width="3" fill="none" stroke="green" d="M4,21 L4,28 L11,28"></path><line x1="5" y1="5" x2="27" y2="27" stroke-width="3" stroke="green"></line><line x1="5" y1="27" x2="27" y2="5" stroke-width="3" stroke="green"></line></svg>'),
	(FamilyTree.toolbarUI.closeFullScreenIcon =
		'<svg  style="margin-bottom:7px;box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid green;background-color: #f9f9f9;display: block;cursor: pointer;" width="32px" height="32px"><path stroke-width="3" fill="none" stroke="#757575" d="M4,11 L4,4 L11,4"></path><path stroke-width="3" fill="none" stroke="#757575" d="M28,11 L28,4 L21,4"></path><path stroke-width="3" fill="none" stroke="#757575" d="M28,21 L28,28 L21,28"></path><path stroke-width="3" fill="none" stroke="#757575" d="M4,21 L4,28 L11,28"></path><rect x="11" y="11" width="10" height="10" stroke-width="3" fill="none" stroke="#757575" ></rect></svg>'),
	(FamilyTree.toolbarUI.zoomInIcon =
		'<svg style="box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border-left: 1px solid green; border-right: 1px solid green; border-top: 1px solid green; background-color: darkseagreen;display: block; cursor: pointer;" width="32px" height="32px" ><g><rect fill="#fff" x="0" y="0" width="32" height="32" ></rect><line x1="8" y1="16" x2="24" y2="16" stroke-width="3" stroke="green"></line><line x1="16" y1="8" x2="16" y2="24" stroke-width="3" stroke="green"></line></g><line x1="4" y1="32" x2="28" y2="32" stroke-width="1" stroke="green"></line></svg>'),
	(FamilyTree.toolbarUI.zoomOutIcon =
		'<svg style="box-shadow: 0px 1px 4px rgba(0,0,0,0.3); margin-bottom:7px; border-left: 1px solid green; border-right: 1px solid green; border-bottom: 1px solid green; background-color: #fff;display: block; cursor: pointer;" width="32px" height="32px" ><g><rect fill="#fff" x="0" y="0" width="32" height="32" ></rect><line x1="8" y1="16" x2="24" y2="16" stroke-width="3" stroke="green"></line></g></svg>'),
	...
	(FamilyTree.wrapText = function (e, t) {
		...
		if (
			...
			for (var u = h.getComputedTextLength(), y = 2; u > c; )
				(h.textContent = e.substring(0, e.length - y)),
					...
					y++;
			return y > 2
				? `<title>${FamilyTree._escapeHtml(e)}</title>${
						h.textContent
				  }`
		...
		if (-1 != m.indexOf('multiline')) {
			...
			for (var F = 1, x = 1; x < g.length; x++) {
				...
				if (
					((b.firstChild.data += ' ' + g[x]),
					b.getComputedTextLength() > c)
				) {
					if (
						((b.firstChild.data = b.firstChild.data.slice(
							0,
							_
						)),
						F++,
	...
	(FamilyTree._downloadFile = function (e, t, i, r, a) {
		...
		if (1 == r) {
			...
			if (void 0 !== o.download) {
				...
				var s = i;
				s.toLowerCase().endsWith(a.toLowerCase()) ||
					(s = s + '.' + a),
	...
	(FamilyTree._xml2json = function (e) {
		for (
			...
			for (var a = t[r], n = {}, l = 0; l < a.attributes.length; l++) {
				...
				n[o.name] = FamilyTree._convertStringToArray(
					o.name,
					o.value
				);
			}
	...
	(FamilyTree._setMinMaxXY = function (e, t) {
		(null == t.minX || (null != e.x && e.x < t.minX)) && (t.minX = e.x),
			(null == t.minY || (null != e.y && e.y < t.minY)) &&
				(t.minY = e.y),
	...
	(FamilyTree._getViewBox = function (e) {
		...
		return e
			? ((t = (t =
					'[' + (t = e.getAttribute('viewBox')) + ']').replace(
					/\ /g,
					','
			  )),
			  (t = JSON.parse(t)))
			...
			this._draw(!1, FamilyTree.action.exporting, r, function (r) {
				...
				if ('svg' == e.ext)
					if (t) t(e, a.innerHTML);
						...
						if (
							!1 ===
							(s = FamilyTree.events.publish('exportend', [
								i,
								o,
							]))
						)
					...
					FamilyTree._importSetColumnNames(n, function (t) {
						for (var r = 1; r < i.length; r++) {
							for (
								...
								var o = t[l],
									s = i[r][l];
								n[o] = FamilyTree._convertStringToArray(
									o,
									s
								);
							}
						...
						0 !=
							FamilyTree.events.publish('import', [
								e,
								d,
			...
			(v.innerHTML = 'Import'),
				...
				(v.onclick = function () {
					(a.style.display = 'none'),
						a._overlay &&
							a._overlay.parentNode.removeChild(
								a._overlay
							);
	...
	(FamilyTree._importCenter = function (e) {
		e &&
			...
			(e.style.top =
				(window.innerHeight - e.offsetHeight) / 2 + 'px'));
	}),
	...
	String.prototype.insert ||
		(String.prototype.insert = function (e, t) {
			return e > 0
				? this.substring(0, e) + t + this.substr(e)
				: t + this;
		}),
		...
		for (var a = t.target; a != e; ) {
			...
			if (
				...
				return (
					t.stopPropagation(),
					t.preventDefault(),
					void this._nodeCircleNodeMenuItemMouseDownHandler(
						a,
						t,
						i
					)
	...
	(FamilyTree.prototype._globalClickHandler = function (e, t) {
		...
		for (var o = t.target; o != e; ) {
			...
			if (
				o.hasAttribute(FamilyTree.attr.control_node_circle_menu_id)
			) {
				t.stopPropagation(), t.preventDefault();
				s = o.getAttribute(
					FamilyTree.attr.control_node_circle_menu_id
		...
		if (n.draggable) {
			...
			var b = function (e, t) {
					if (null != e) {
						...
						for (
							var i = FamilyTree.getStParentNodes(
									l.getNode(c)
								),
								r = 0;
							r < i.length;
					...
					if (h) {
						...
						var o = FamilyTree._getOffsetXY(l.element, t),
							s = {
								left:
									l.width() -
										(o.x + l.config.padding) <
									0,
								right: o.x - l.config.padding < 0,
								up:
									l.height() -
										(o.y + l.config.padding) <
									0,
					...
					if (c) {
						...
						var a = FamilyTree._getOffsetXY(s.element, t),
							g = {
								left:
									s.width() -
										(a.x + s.config.padding) <
									0,
								right: a.x - s.config.padding < 0,
								up:
									s.height() -
										(a.y + s.config.padding) <
									0,
	...
	(FamilyTree.searchUI.prototype.init = function (e) {
		...
		var c = function () {
				var e = t.obj.element.querySelectorAll(
						'[data-search-item-id]'
					),
					i = t.obj.element.querySelector(
						'[data-selected="yes"]'
					);
				null == i && e.length > 0
	...
	(FamilyTree.searchUI.prototype._search = function () {
				...
				for (
					...
					t.obj.config.searchDisplayField == a.__searchField
						...
						? ((o = a[t.obj.config.searchDisplayField]),
						  ...
						  (s = a.__searchMarks))
						: (o = a.__searchMarks),
						(e += FamilyTree.searchUI.createItem(
							n,
							a.id,
							o,
							s
		...
		for (
			var r = this.obj.element.querySelectorAll(
					'[data-search-item-id]'
				),
				a = 0;
			a < r.length;
				...
				if (this.hasAttribute('data-search-item-id')) {
					...
					if (t.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
						if (
							...
							var i = t.obj.element.querySelector(
								'[data-selected="yes"]'
							);
				...
				function (t) {
					...
					i.state &&
						...
						i.action == FamilyTree.action.exporting
							? (l = i._fixAdjustForExport)
							: (i._fixAdjustForExport = l);
					for (
						var o = {
								minX: null,
								minY: null,
	...
	(FamilyTree.manager._setCollpasedProperty = function (
		e,
		t,
		i,
		r,
	...
	(FamilyTree.manager._initNode = function (e, t, i, r, a, n, l) {
		var o = l.manager.config,
			...
			p = s[i || 'base'];
		null == e.parent &&
			FamilyTree.manager._setCollpasedProperty(
				e,
				p,
				c,
				a,
	...
	(FamilyTree.manager._iterate = function (
		...
		if (
			...
			t.isAssistant &&
				(n[t.pid] || (n[t.pid] = []), n[t.pid].push(t.id)),
	...
	(FamilyTree.manager._createNodes = function (e) {
				...
				if (m) {
					...
					if (!f) {
						if (!FamilyTree.isNEU(m.pid))
							(H = (T = o[m.pid]).childrenIds.indexOf(
								m.id
							)) > -1 && T.childrenIds.splice(H, 1);
						s.push(m);
					}
				}
			}
		...
		if (
			...
			for (var b = o[a.id]; b; ) {
				if (
					...
					a.options.parentState ===
						FamilyTree.COLLAPSE_PARENT_NEIGHBORS && b)
				)
			...
			b = o[a.id];
			if (
				a.options.childrenState ===
				FamilyTree.COLLAPSE_SUB_CHILDRENS
			)
				for (c = 0; c < b.childrenIds.length; c++) {
		...
		for (c = 0; c < S.length; c++) {
				...
				(R = g.children[v]).isAssistant
					...
					? -1 != R.tags.indexOf('partner') && E % 2
						? ((R.isPartner = 2),
						  ...
						  E++)
						: R.parentPartner
						? (A[R.parentPartner.id] ||
								(A[R.parentPartner.id] = []),
						  A[R.parentPartner.id].push(R.id))
						: C.push(R.id)
					: ((R.isPartner = 1),
					  (R.children = []),
					  I.push(R.id),
			...
			for (v = 0; v < I.length; v++) {
				A[(R = o[I[v]]).id]
					? g.children.push(R)
					: g.children.splice(0, 0, R);
				for (var P = 0; P < R.childrenIds.length; P++)
					B.push(R.childrenIds[P]);
			}
			var D = [];
			for (v = 0; v < N.length; v++) {
				A[(R = o[N[v]]).id]
					? g.children.push(R)
					: g.children.splice(0, 0, R);
				for (P = 0; P < R.childrenIds.length; P++)
					D.push(R.childrenIds[P]);
			}
			...
			for (v = N.length - 1; v >= 0; v--)
				if (A[N[v]])
					for (u = 0; u < A[N[v]].length; u++)
						g.children.push(o[A[N[v]][u]]),
							M++,
							-1 == U.indexOf(N[v]) && U.push(N[v]);
			...
			for (v = 0; v < I.length; v++)
				if (A[I[v]])
					for (u = 0; u < A[I[v]].length; u++)
						g.children.push(o[A[I[v]][u]]),
							L++,
							-1 == O.indexOf(I[v]) && O.push(I[v]);
			for (v = 0; v < B.length; v++) {
				(R = o[B[v]]).collapsed ||
					((R.parentPartner = R.parent),
					(R.parent = g),
			...
			for (v = 0; v < g.subLevels; v++) {
				...
				if (
					...
					(H = T.children.indexOf(g)) > -1 &&
						(T.children.splice(H, 1),
						T.children.splice(H, 0, j)),
						j.children.push(g),
						(j.parent = T),
						(g.parent = j),
						(o[j.id] = j);
				...
				if (re) {
					...
					for (var $ in ((k = {}), le))
						if (
							...
							var me = oe[$];
							for (
								c = o[me].children.length - 1;
								c >= 0;
								c--
							) {
								R = o[me].children[c];
								le[$].has(R.id) &&
									o[me].children.splice(c, 1);
							}
						}
					for (var $ in ne)
						ne[$].length >
				...
				if ((z = i[T.lcn ? T.lcn : 'base']).layout > 0 || te)
					if (
						...
						for (c = ie.childrenIds.length - 1; c >= 0; c--) {
							for (
								R = o[ie.childrenIds[c]], v = 0;
								v < T.children.length;
								v++
							)
								T.children[v].id == R.id &&
									T.children.splice(v, 1);
							if (
								((R.parent = null),
								(R.layout = ie.layout),
	...
	(FamilyTree.manager._getResponse = function (
		...
		if (
			...
			(g.minY = o),
			0 == d.length ||
				(null == s && !f && r.align == FamilyTree.CENTER))
		) {
			var x = Math.ceil(e / F),
				_ = Math.ceil(t / F),
				w = 0,
			...
			if (_ - 2 * r.padding >= n - o)
				...
				switch (
					((k = -(_ / 2 - (n - o) / 2)) > -r.padding &&
						(k = -r.padding),
					r.orientation)
				) {
					case FamilyTree.orientation.bottom:
					case FamilyTree.orientation.bottom_left:
						(k = -(_ / 2 - (o - n) / 2)) < r.padding - _ &&
							(k = r.padding - _);
						break;
					case FamilyTree.orientation.left:
					case FamilyTree.orientation.right:
	...
	(FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, l, o, s, d) {
		if (FamilyTree.manager._isVisible(e, i, r, a)) {
			...
			if (
				...
				if (
					(!(f = o[e.id]) ||
						(FamilyTree.isNEU(f.x) &&
							FamilyTree.isNEU(f.y))) &&
					n
				) {
					if ((u = t[n.id])) {
	...
	(FamilyTree.manager._verticalAssistantIterate = function (e, t) {
		...
		if (3 == e.children.length)
			FamilyTree.manager._verticalAssistantIterate(e.children[0], t),
				FamilyTree.manager._verticalAssistantIterate(
					e.children[2],
					t
				),
				FamilyTree.manager._verticalAssistantIterate(
		...
		if (
			...
			h || f
				? (m && ((c.collapsed = m.collapsed), (c.min = m.min)),
				  ...
				  h &&
						!h.ftChildrenIds.has(c.id) &&
						h.ftChildrenIds.push(c.id),
				  f &&
						!f.ftChildrenIds.has(c.id) &&
						f.ftChildrenIds.push(c.id))
				: (m && ((c.collapsed = m.collapsed), (c.min = m.min)),
				  n.push(c));
			...
			if (g) {
				...
				if (
					...
					for (var b = 0; b < i[g.id].length; b++) {
						var v = r[i[g.id][b]];
						v &&
							(FamilyTree.isNEU(v.fid) ||
								FamilyTree.isNEU(v.mid)) &&
							FamilyTree.manager._iterateFT(
								i[g.id][b],
								t,
								i,
	...
	(FamilyTree.templates.base = {
		...
		<g id="base_node_menu" style="cursor:pointer;"><rect x="0" y="-8" fill="#fff" width="30" height="30" rx="10px" stroke="gray"></rect><circle cx="8" cy="7" r="2" fill="gray"></circle><circle cx="15" cy="7" r="2" fill="gray"></circle><circle cx="22" cy="7" r="2" fill="gray"></circle></g>\n            <g style="cursor: pointer;" id="base_tree_menu">\n                <rect x="0" y="0" rx="50" width="35" height="35" fill="#fff" stroke="gray"></rect>\n                ${FamilyTree.icon.addUser(
			25,
			25,
			'gray',
			7,
			7
		)}\n            </g>\n            <g style="cursor: pointer;" id="base_tree_menu_close">\n                <circle cx="19" cy="19" r="15" fill="#fff"></circle>\n                ${FamilyTree.icon.close(
			30,
			30,
			'red',
			4,
			4
		)}\n            </g>            \n            <g id="base_up">\n                <circle cx="100" cy="90" r="15" fill="#fff" stroke="green" stroke-width="1"></circle>\n                ${FamilyTree.icon.ft(
			24,
			24,
			'gray',
			87,
		...
		nodeTreeMenuButton:
			'<use data-ctrl-n-t-menu-id="{id}" x="285" y="60" xlink:href="#base_tree_menu"/>',
		nodeTreeMenuCloseButton:
			'<use data-ctrl-n-t-menu-c="" x="285" y="60" xlink:href="#base_tree_menu_close"/>',
	...
	(FamilyTree.templates.tommy = Object.assign(
		{},
		FamilyTree.templates.base
	)),
	...
	(FamilyTree.templates.son = Object.assign(
		{},
		FamilyTree.templates.mother
	)),
	...
	(FamilyTree.templates.pet = Object.assign(
		{},
		FamilyTree.templates.mother
	)),
	...
	(FamilyTree.templates.split = Object.assign(
		{},
		FamilyTree.templates.base
	)),
		...
		expandCollapseBtn: function (e, t, i, r, a) {
			...
			if (r !== FamilyTree.action.exporting && !t.isSplit) {
				...
				if (t.childrenIds.length > 0) {
					...
					if (
						-1 !=
						n.indexOf('{collapsed-children-total-count}')
					) {
						var f = FamilyTree.collapsedChildrenTotalCount(
							e,
							t
						);
						n = n.replace(
			...
			var g = { html: n, node: t };
			return (
				FamilyTree.events.publish('renderbuttons', [e, g]), g.html
			);
		},
				...
				for (var C in t.config.linkBinding) {
					...
					if (N) {
						...
						(k.value = A),
							...
							(k.name = I),
							!1 !==
								FamilyTree.events.publish('label', [
									t,
									k,
								]) &&
					...
					: 2 == n.isPartner &&
					  ((l =
							...
							((e.leftIds.length - 1) *
								...
								2),
					  e.firstRight &&
					  l > e.firstRight.x + e.firstRight.w / 2
							? l < i.x + i.w / 2
								? (r -= (e.indexes[i.id] + 1) * a)
								: (r -=
										(e.leftIds.length -
					...
					: 2 == n.isPartner &&
					  ((l =
							...
							((e.leftIds.length - 1) *
								...
								2),
					  e.firstRight &&
					  l > e.firstRight.y + e.firstRight.h / 2
							? l < i.y + i.h / 2
								? (r -= (e.indexes[i.id] + 1) * a)
								: (r -=
										(e.leftIds.length -
			...
			!(function (e, i, r) {
				...
				e.addEventListener(
					...
					function (e) {
						var r = 0;
						if (
							t.config.mouseScrool ==
							FamilyTree.action.xScroll
						)
							(r = e.deltaX || e.wheelDeltaX) ||
								(r = e.deltaY || e.wheelDeltaY);
						else if (
							t.config.mouseScrool ==
								FamilyTree.action.scroll &&
							!(r = e.shiftKey
				...
				this.bar.addEventListener('scroll', function () {
					if (this.ignore) this.ignore = !1;
						...
						var e = t.requestParams(),
							...
							r = this.scrollLeft / i,
							a =
								(e.boundary.right - e.boundary.left) /
								100;
				...
				this.bar.addEventListener('scroll', function () {
					if (this.ignore) this.ignore = !1;
						...
						var e = t.requestParams(),
							...
							r = this.scrollTop / i,
							a =
								(e.boundary.bottom - e.boundary.top) /
								100;
	...
	(FamilyTree.prototype._clink = function (e, t) {
		for (var i = '', r = 0; r < this.config.clinks.length; r++) {
			...
			if (
				...
				l &&
				-1 != t.res.visibleNodeIds.indexOf(l.id)
			) {
				var o = n.x,
					s = n.y,
					d = l.x,
				...
				for (; null == d; ) {
					...
					if (
						...
						for (; F; ) {
							...
							FamilyTree._intersects(F, u, e.config) &&
								((u = FamilyTree._addPoint(
									F,
									s,
									e.config,
					...
					if (!T) {
						...
						if (b.parent) {
							(f = p.levelSeparation),
								b.parent.layout &&
									(f =
										p.mixedHierarchyNodesSeparation);
							var w =
			...
			t.node.min
				...
				(a = (a += '</g>')
					...
					.replaceAll(
						'{ew}',
						t.node.w -
							(t.node.padding ? t.node.padding[1] : 0)
					)
					.replaceAll(
						'{eh}',
						t.node.h -
							(t.node.padding ? t.node.padding[2] : 0)
					));
				...
				for (l = 0; l < n.stChildrenIds.length; l++)
					r++,
						a.includes(n.id) ||
							(1 == r
								? (i.fillStyle =
										FamilyTree.miniMap.colors[0])
								: 2 == r
								? (i.fillStyle =
										FamilyTree.miniMap.colors[1])
								: 3 == r &&
								  (i.fillStyle =
		...
		if (!e.element.querySelector('[data-id="mini-map"]')) {
			...
			(t.width = FamilyTree.miniMap.width),
				...
				(t.style.backgroundColor =
					FamilyTree.miniMap.backgroundColor),
			...
			for (
				...
				FamilyTree.isNEU(FamilyTree.miniMap.position[l]) ||
					('padding' == FamilyTree.miniMap.position[l]
						...
						: (r.style[l] =
								FamilyTree.miniMap.position[l] + 'px'));
			}
	...
	(FamilyTree._search.addNodeToResult = function (e, t, i, r, a, n) {
		...
		for (var o = 0; o < t.length; o++) {
			var s = t[o];
			FamilyTree.isNEU(i[s]) ||
				(FamilyTree.isNEU(l[s]) && (l[s] = i[s]));
		}
		null != r &&
			(FamilyTree.isNEU(l.__score) && (l.__score = r.__score),
			FamilyTree.isNEU(l.__searchField) && (l.__searchField = a),
			FamilyTree.isNEU(l.__searchMarks) &&
				(l.__searchMarks = r.__searchMarks)),
			e.push(l);
	}),
		...
		if (o) {
			...
			o.writeToIndexedDB &&
				...
				FamilyTree.idb.put(d, function (e) {
					0 == e &&
						console.error('Cannot write row - ' + o.name);
				})),
			...
			if (e.readFromUrlParams) {
				...
				if (
					...
					((m = [])[0] = s),
						...
						(l.roots = null),
						n.has(a.paramRoots) &&
							(l.roots = n.get(a.paramRoots).split('*')),
			...
			if (!1 !== FamilyTree.events.publish('key-down', [this, n]) && a)
				if ('KeyF' == t.code) this.searchUI.find('');
					...
					a.childrenIds.length &&
						((this._keyNavigationActiveNodeId =
							a.childrenIds[0]),
	...
	FamilyTree.events.on('click', function (e, t) {
		e.config &&
			e.config.keyNavigation &&
			((e._keyNavigationActiveNodeId = t.node.id),
			e.center(t.node.id));
	}),
	...
	(FamilyTree.prototype.showTreeMenu = function (e) {
		...
		if (
			('male' == c.gender
				? ((f.templateName = 'wife'),
				  (f._ft_data.gender = 'female'))
				: 'female' == c.gender &&
				  ((f.templateName = 'husband'),
		...
		for (g = 0; g < o.length; g++)
			((o[g].fid == c.id && FamilyTree.isNEU(o[g].mid)) ||
				...
				(o[g].fid == c.id
					...
					: o[g].mid == c.id &&
					  (o[g].fid = '_ft_partner_for_single_child'),
				m.push(o[g]),
				T.push(o[g].id));
		if (T.length) {
			var b = {
			...
			'male' == c.gender
				? ((b.templateName = 'wife'),
				  (b._ft_partnerData.gender = 'female'))
				: 'female' == c.gender &&
				  ((b.templateName = 'husband'),
	...
	(FamilyTree.prototype.onDrop = function (e) {
		return this.on('drop', function (t, i, r, a, n) {
			var l = { dragId: i, dropId: r, dragNodeElement: a, event: n };
			return e.call(t, l);
		});
	}),
					...
					if (
						...
						for (
							var t =
								...
								i =
									d.instance.element.querySelectorAll(
										'[data-filter-menu]'
									),
								r = 0;
							r < i.length;
						...
						var n = d.instance.element.querySelector(
							'[data-filter-close]'
						);
						if (
	...
	(FamilyTree.remote._toReqDTO = function (e, t) {
		...
		e.children.length > 0 &&
			...
			e.lcn && (i.k = e.lcn),
			e.stContainerNodes &&
				(i.b = FamilyTree.remote._convertToIdArray(
					e.stContainerNodes
				)),
			e._m && (i.m = e._m.id),
